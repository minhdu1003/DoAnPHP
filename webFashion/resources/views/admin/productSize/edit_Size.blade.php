...
<form method="POST" action="{{route('product-size.update',[$sizes->Size])}}">
  @method('PUT')
  @csrf
<div class="modal-dialog-small modal-dialog-centered" role="document">
  <div class="modal-content">
      ...
      <div class="form-group" style="display:flex; margin-top:10px">
						<p >Tên kích cỡ:&emsp;</p>
						<input style="width:350px" value="{{$sizes->SizeName}}" name="size" type="text" class="form-control" id="hoten-edit" placeholder="Nhập kích cỡ">
					</div>
      ...
      <div class="modal-footer">
        ...
        <a href="{{route('product-size.index')}}" type="button" class="btn btn-secondary" data-dismiss="modal">Thoát</a>
        </div>
      </div>
    </div>
