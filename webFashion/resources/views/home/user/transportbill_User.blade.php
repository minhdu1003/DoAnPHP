...
<div class="container">
        <div class="info" style="padding: 80px 25px 50px 25px">
          ...
          <div class="col-sm-2">
            ...
            <div class="panel-heading">Tài khoản của tôi</div>
              ...
              <a href="{{route('success-bill.successbillUser', $result->CustomerID)}}"><p style="font-size: 12px;"><span><i class="fas fa-clipboard-check"></i></span> Giao thành công</p></a>
                ...
                <a href="{{route('judge-product.judgeProduct', $result->CustomerID)}}"><p style="font-size: 12px;"><span><i class="fas fa-gavel"></i></i></span> Đánh giá sản phẩm </p></a>
              </div>
          ...
          <div class="col-md-10 col-sm-9 col-xs-12">
            <div class="title">
                <p style="text-align:center; font-size:16px; font-weight:bold">Đanh sách đơn hàng đang vận chuyển</p>
            </div>
            <table class="table table-hover">
            <thead>
                <tr>
                <th scope="col" style="text-align:center">BillID</th>
