    ...
    <section class="cartegory">
        <div class="container">
            <div class="cartegory-top row">
                <p><a href="">Trang chủ</a> </p> <span>⟶</span> <p>Thương hiệu {{$taglink}}</p>
            </div>
        </div>
        <div class="container">
            <div class="row">
                        ...
                        @foreach($productnew as $productnews)
                            <li style="overflow:auto">
                                <div style="display:flex;">
                                    ...
                                    <a style="text-decoration:none;color:black" href="{{route('product-detalis.show',[$productnews->ProductID])}}"><p style="margin-left:5px;margin-top:7px;width:130px;">
